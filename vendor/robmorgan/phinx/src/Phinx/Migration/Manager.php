...
class Manager
{
    ...
    public function seed($environment, $seed = null)
    {
        ...
        if ($seed === null) {
            ...
            if (array_key_exists($seed, $seeds)) {
                ...
                throw new InvalidArgumentException(sprintf('The seeds class "%s" does not exist', $seed));
            }
        }
    }
    ...
    /**
     * Get seeds dependencies instances from seeds dependency array
     *
    ...
    /**
     * Returns a list of seeds files found in the provided seeds paths.
     *
     * @return string[]
     */
