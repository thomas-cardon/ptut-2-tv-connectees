...
abstract class AbstractCommand extends Command
{
    ...
    /**
     * The location of the default seeds template.
     */
    ...
    public function bootstrap(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln('<info>using seeds paths</info> ');
    ...
    /**
     * Verify that the seeds directory exists and is writable.
     *
     * @param string $path
     *
     * @throws \InvalidArgumentException
    ...
    /**
     * Returns the seeds template filename.
     *
     * @return string
     */
