...
armer StudentController zum erstenmale hier in den Hof kam".—Lotte fragte nach seiner
...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    - You pay a royalty fee of 20% of the gross profits you derive from
         ...
         address specified in Section 4, "InformationController about donations to
    ...
    Section  2.  InformationController about the Mission of Project Gutenberg-tm
    ...
    Section 3.  InformationController about the Project Gutenberg Literary Archive
    Foundation
    ...
    Section 4.  InformationController about Donations to the Project Gutenberg
    ...
    Section 5.  General InformationController About Project Gutenberg-tm electronic
    works.
