...
function wpdocs_plugin_teleconnecteeAmu_scripts() {
	...
	wp_enqueue_script('plugin-scroll', TV_PLUG_PATH . 'views/js/scroll.js', array('plugin-jquerymin', 'plugin-jqueryEzTic', 'plugin-jqueryEzMinTic', 'plugin-JqueryEzMin'), '', true);
